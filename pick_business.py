...
class PickBusinessScreen:
    ...
    #     pick_category = self.driver.find_element(By.XPATH, "//a[@role='button' and @title='גיפט קארד למותגי אופנה']")
    #     # self.execute_script("arguments[0].scrollIntoView();", pick_category)
    #     pick_category.click()
    #
    # def choose_gift_card(self):
    #     gift_card = self.driver.find_element(By.XPATH, "//a[@aria-label='            \n\n        \n            \n        \n\n\n\n\n\n    \n        BUYME TOTAL FASHION\n    \n\n\n']")
    #     gift_card.click()
    #
